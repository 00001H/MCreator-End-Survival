...
import net.mcreator.endsurvival.procedures.EndCrafterOnCraftProcedure;
...
public class EndCrafterGuiGui extends EndSurvivalModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public EndCrafterGuiGui(EndSurvivalModElements instance) {
		super(instance, 51);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("end_crafter_gui"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, EndCrafterGuiGuiWindow::new));
	}
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 53, 38) {
				...
				public boolean isItemValid(ItemStack stack) {
					return (EndEssenceItem.block == stack.getItem());
				}
			}));
	...
	static void handleButtonAction(PlayerEntity entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			EndCrafterOnCraftProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
