...
import net.mcreator.endsurvival.procedures.HeatConderserUpdateTickProcedure;
import net.mcreator.endsurvival.procedures.HeatCondenserBlockAddedProcedure;
import net.mcreator.endsurvival.gui.HeatCondenserGuiGui;
	...
	public static class CustomBlock extends Block {
		...
		public void onBlockAdded(BlockState blockstate, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 20);
			{
				...
				HeatCondenserBlockAddedProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				HeatConderserUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 20);
		}
